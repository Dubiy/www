...
(function(root, factory) {
  ...
  // event aggregator as `application.vent`
  ...
  _.extend(Marionette.Application.prototype, Backbone.Events, {
    ...
    // to the application, and runs all of the initializer functions
    ...
    // Add regions to your application.
    ...
    // Empty all regions in the application, without removing them
    emptyRegions: function() {
      return this._regionManager.emptyRegions();
    },
  
    // Removes a region from your application, by name
  ...
  Marionette.Module = function(moduleName, app, options) {
    ...
    // Set an internal reference to the application
    // within a module.
    this.app = app;
  ...
  _.extend(Marionette.Module, {
    ...
    // Create a module, hanging off the application parameter as the parent object.
